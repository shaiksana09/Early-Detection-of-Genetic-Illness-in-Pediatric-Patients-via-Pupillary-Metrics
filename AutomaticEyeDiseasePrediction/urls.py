"""AutomaticEyeDiseasePrediction URL Configuration
...
from AutomaticEyeDiseasePrediction import views as mainView
...
urlpatterns = [
    ...
    path("UserPupillometry/", usr.UserPupillometry, name="UserPupillometry"),
